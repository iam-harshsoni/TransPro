...
<div class="page-header">\r
    ...
    <div class="page-title">Routes</div>\r
    <div class="page-subtitle">Manage transport routes and distances</div>\r
</div>\r
\r
<div class="card">\r
\r
    <p-toolbar class="table-toolbar">\r
        <ng-template #start>\r
            <p-iconfield>\r
                ...
                <input pInputText type="text" placeholder="Search routes..." (input)="onSearch($event)" />\r
            </p-iconfield>\r
        </ng-template>\r
        <ng-template #end>\r
            <p-button label="New Route" icon="pi pi-plus" (onClick)="navigateToCreate()" />\r
        </ng-template>\r
    </p-toolbar>\r
\r
    <p-table #dt [value]="appRoutes()" [loading]="isLoading()" [lazy]="true" (onLazyLoad)="onLazyLoad($event)"\r
        ...
        currentPageReportTemplate="Showing {first} to {last} of {totalRecords} routes"\r
        [tableStyle]="{ 'min-width': '55rem' }">\r
\r
        <ng-template pTemplate="caption">\r
            <div class="table-caption">\r
                <span class="table-title">Route List</span>\r
...
\r
        <ng-template pTemplate="header">\r
            <tr>\r
                ...
                <th pSortableColumn="origin" style="min-width: 14rem">\r
                    Origin <p-sortIcon field="origin" />\r
                </th>\r
                <th pSortableColumn="destination" style="min-width: 14rem">\r
                    Destination <p-sortIcon field="destination" />\r
                </th>\r
                <th pSortableColumn="distanceKm" style="min-width: 10rem">\r
                    Distance <p-sortIcon field="distanceKm" />\r
                </th>\r
                <th pSortableColumn="estimatedHours" style="min-width: 10rem">\r
                    Est. Duration <p-sortIcon field="estimatedHours" />\r
                </th>\r
\r
            </tr>\r
        </ng-template>\r
\r
        <ng-template pTemplate="body" let-route>\r
            <tr>\r
                <td>\r
                    <div class="row-actions">\r
                        <p-button icon="pi pi-pencil" [rounded]="true" [outlined]="true" size="small" pTooltip="Edit"\r
                            tooltipPosition="top" (onClick)="navigateToEdit(route)" />\r
                    </div>\r
                </td>\r
                <td>\r
                    <div class="route-origin-cell">\r
                        <i class="pi pi-map-marker route-pin"></i>\r
                        <span class="row-name">{{ route.origin }}</span>\r
                    </div>\r
                </td>\r
                <td>\r
                    <div class="route-origin-cell">\r
                        <span class="row-name">{{ route.destination }}</span>\r
                    </div>\r
                </td>\r
                <td>\r
                    <p-tag [value]="formatDistance(route.distanceKm)"\r
                        [severity]="getDistanceSeverity(route.distanceKm)" />\r
                </td>\r
                <td>\r
                    <div class="duration-cell">\r
                        <i class="pi pi-clock"></i>\r
                        <span>{{ formatHours(route.estimatedHours) }}</span>\r
                    </div>\r
                </td>\r
            </tr>\r
        </ng-template>\r
            ...
            <tr>\r
                <td colspan="5">\r
                    <div class="empty-state">\r
                        ...
                        <span>No routes found</span>\r
                        <small>Add your first route to get started</small>\r
                    </div>\r
                </td>\r
            </tr>\r
        </ng-template>\r
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(RouteListComponent, { className: "RouteListComponent", filePath: "app/features/routes/pages/route-list/route-list.component.ts", lineNumber: 38 });
})();
export {
  RouteListComponent
};
//# sourceMappingURL=chunk-3ZCLKJ3M.js.map
