...
<div class="page-header">\r
    ...
    <div class="page-title">Customers</div>\r
    <div class="page-subtitle">Manage your customer records</div>\r
</div>\r
\r
<div class="card">\r
\r
    <p-toolbar class="table-toolbar">\r
        <ng-template #start>\r
            <p-iconfield>\r
                ...
                <input pInputText type="text" placeholder="Search customers..." (input)="onSearch($event)" />\r
            </p-iconfield>\r
        </ng-template>\r
        <ng-template #end>\r
            <p-button label="New Customer" icon="pi pi-plus" (onClick)="navigateToCreate()" />\r
        </ng-template>\r
\r
    </p-toolbar>\r
\r
    <!-- [lazy]="true" tells PrimeNG to NOT paginate client-side.\r
    Instead it fires (onLazyLoad) every time the page changes.\r
    Our component handles that event and fetches the correct page from API.\r
\r
    [totalRecords] tells the paginator how many total records exist\r
    so it can calculate how many pages to show.\r
    This value comes from the API response (response.totalCount).\r
  -->\r
    <p-table #dt [value]="customers()" [loading]="isLoading" [lazy]="true" (onLazyLoad)="onLazyLoad($event)"\r
        ...
        currentPageReportTemplate="Showing {first} to {last} of {totalRecords} customers"\r
        [tableStyle]="{ 'min-width': '60rem' }">\r
\r
        <ng-template pTemplate="caption">\r
            <div class="table-caption">\r
                <span class="table-title">Customer List:</span>\r
...
\r
        <ng-template pTemplate="header">\r
            <tr>\r
                ...
                <th pSortableColumn="email" style="min-width: 16rem">\r
                    Email <p-sortIcon field="email" />\r
                </th>\r
                <th style="min-width: 11rem">Phone</th>\r
                <th style="min-width: 8rem">Status</th>\r
                <th style="width: 8rem; text-align: center">Actions</th>\r
            </tr>\r
        </ng-template>\r
\r
        <ng-template pTemplate="body" let-customer>\r
            <tr>\r
                <td><span class="row-name breadcrumb-link cursor-pointer" (click)="navigateToEdit(customer)"\r
                        pTooltip="Edit" tooltipPosition="top">{{\r
                        customer.fullName }}</span></td>\r
                <td>{{ customer.email }}</td>\r
                <td>{{ customer.phone }}</td>\r
                <td>\r
                    <p-tag [value]="customer.isActive ? 'Active' : 'Inactive'"\r
                        [severity]="getSeverity(customer.isActive)" />\r
                </td>\r
                <td>\r
                    <div class="row-actions">\r
                        <p-button icon="pi pi-pencil" [rounded]="true" [outlined]="true" size="small" pTooltip="Edit"\r
                            tooltipPosition="top" (onClick)="navigateToEdit(customer)" />\r
                        <!-- <p-button icon="pi pi-trash" severity="danger" [rounded]="true" [outlined]="true" size="small"\r
                            pTooltip="Delete" tooltipPosition="top" (onClick)="confirmDelete(customer)" /> -->\r
                    </div>\r
                </td>\r
            </tr>\r
        </ng-template>\r
            ...
            <tr>\r
                <td colspan="6">\r
                    <div class="empty-state">\r
                        ...
                        <span>No customers found</span>\r
                        <small>Add your first customer to get started</small>\r
                    </div>\r
                </td>\r
            </tr>\r
        </ng-template>\r
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(CustomerListComponent, { className: "CustomerListComponent", filePath: "app/features/customers/pages/customer-list/customer-list.component.ts", lineNumber: 41 });
})();
export {
  CustomerListComponent
};
//# sourceMappingURL=chunk-6UB2EJLT.js.map
