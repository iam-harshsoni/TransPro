...
var Scroller = class _Scroller extends BaseComponent {
  ...
  set options(val) {
    ...
    if (val && typeof val === "object") {
      ...
      Object.entries(val).forEach(([k, v2]) => this[`${k}`] !== v2 && (this[`${k}`] = v2));
    }
  }
  /**
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({
    ...
    contentQueries: function Scroller_ContentQueries(rf, ctx, dirIndex) {
      if (rf & 1) {
        \u0275\u0275contentQuery(dirIndex, _c03, 4)(dirIndex, _c12, 4)(dirIndex, _c22, 4)(dirIndex, _c32, 4)(dirIndex, PrimeTemplate, 4);
      }
      if (rf & 2) {
        let _t;
        \u0275\u0275queryRefresh(_t = \u0275\u0275loadQuery()) && (ctx.contentTemplate = _t.first);
...
//# sourceMappingURL=chunk-GSXUK7A5.js.map
