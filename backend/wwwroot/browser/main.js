...
var LayoutService = class _LayoutService {
  ...
  static \u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({
    ...
    providedIn: "root"
    // registered globally — like AddSingleton() in ASP.NET Core
  });
};
(() => {
...
var _forTrack0 = ($index, $item) => $item.groupLabel;
...
function SidebarComponent_For_6_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(group_r1.groupLabel);
  }
}
function SidebarComponent_For_6_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "div", 10);
  }
}
function SidebarComponent_For_6_For_4_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
...
function SidebarComponent_For_6_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(1, SidebarComponent_For_6_Conditional_1_Template, 2, 1, "span", 9)(2, SidebarComponent_For_6_Conditional_2_Template, 1, 0, "div", 10);
    \u0275\u0275repeaterCreate(3, SidebarComponent_For_6_For_4_Template, 3, 5, "a", 11, _forTrack1);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275conditional(!ctx_r2.layout.sidebarCollapsed() ? 1 : 2);
    \u0275\u0275advance(2);
...
var SidebarComponent = class _SidebarComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SidebarComponent, selectors: [["app-sidebar"]], decls: 12, vars: 3, consts: [[1, "sidebar"], [1, "sidebar-logo"], [1, "pi", "pi-send", "logo-icon"], [1, "logo-text"], [1, "sidebar-nav"], [1, "nav-group"], [1, "sidebar-footer"], [1, "sidebar-user", 3, "click"], [1, "user-avatar-small"], [1, "nav-group-label"], [1, "nav-group-divider"], ["routerLinkActive", "active", "tooltipPosition", "right", 1, "nav-item", 3, "routerLink", "pTooltip"], ["routerLinkActive", "active", "tooltipPosition", "right", 1, "nav-item", 3, "click", "routerLink", "pTooltip"], [1, "user-info-small"], [1, "user-name-small"], [1, "user-role-small"], [1, "pi", "pi-sign-out", "logout-btn"]], template: function SidebarComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275element(2, "i", 2);
      \u0275\u0275conditionalCreate(3, SidebarComponent_Conditional_3_Template, 2, 0, "span", 3);
      \u0275\u0275elementEnd();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(SidebarComponent, [{
    type: Component,
    args: [{ selector: "app-sidebar", standalone: true, imports: [RouterLink, RouterLinkActive, CommonModule, TooltipModule], template: `<div class="sidebar">\r
\r
    <!-- Logo -->\r
    <div class="sidebar-logo">\r
        <i class="pi pi-send logo-icon"></i>\r
        @if (!layout.sidebarCollapsed()) {\r
        <span class="logo-text">TransPro</span>\r
        }\r
    </div>\r
\r
    <!-- Navigation -->\r
    <nav class="sidebar-nav">\r
        @for (group of navGroups; track group.groupLabel) {\r
        <div class="nav-group">\r
\r
            @if (!layout.sidebarCollapsed()) {\r
            <span class="nav-group-label">{{ group.groupLabel }}</span>\r
            } @else {\r
            <div class="nav-group-divider"></div>\r
            }\r
\r
...
var ShellComponent = class _ShellComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ShellComponent, selectors: [["app-shell"]], hostBindings: function ShellComponent_HostBindings(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275listener("keydown", function ShellComponent_keydown_HostBindingHandler($event) {
...
var routes = [
  {
    path: "login",
    loadComponent: () => import("./chunk-2L6YYBTA.js").then((m4) => m4.LoginComponent)
  },
  {
    path: "",
    ...
    children: [
      ...
      {
        path: "customers",
        loadChildren: () => import("./chunk-ROFPLUUY.js").then((m4) => m4.customerRoutes)
      },
      {
        path: "drivers",
        loadChildren: () => import("./chunk-XHATW4C4.js").then((m4) => m4.driverRoutes)
      },
      {
        path: "containers",
        loadChildren: () => import("./chunk-NFEJBVTQ.js").then((m4) => m4.containerRoutes)
      },
      {
        path: "trucks",
        loadChildren: () => import("./chunk-EOJWEQMD.js").then((m4) => m4.truckRoutes)
      },
      {
        path: "routes",
        loadChildren: () => import("./chunk-GVLTRWYZ.js").then((m4) => m4.routesRoutes)
      },
      {
        path: "trips",
        loadChildren: () => import("./chunk-WD3MOBLR.js").then((m4) => m4.tripRoutes)
      },
      {
        path: "",
...
var __spreadValues2 = (a42, b5) => {
  for (var prop in b5 || (b5 = {}))
    if (__hasOwnProp.call(b5, prop))
      __defNormalProp(a42, prop, b5[prop]);
...
var __spreadProps2 = (a42, b5) => __defProps(a42, __getOwnPropDescs(b5));
...
function initZone() {
  ...
  const _ZoneImpl = class _ZoneImpl2 {
    ...
    _updateTaskCount(task, count) {
      ...
      for (let i28 = 0; i28 < zoneDelegates.length; i28++) {
        zoneDelegates[i28]._updateTaskCount(task.type, count);
      }
    }
  };
  ...
  function drainMicroTaskQueue() {
    if (!_isDrainingMicrotaskQueue) {
      ...
      while (_microTaskQueue.length) {
        ...
        _microTaskQueue = [];
        for (let i28 = 0; i28 < queue.length; i28++) {
          const task = queue[i28];
          try {
...
function bindArguments(args, source) {
  for (let i28 = args.length - 1; i28 >= 0; i28--) {
    if (typeof args[i28] === "function") {
      args[i28] = wrapWithCurrentZone(args[i28], source + "_" + i28);
    }
  }
  return args;
}
function patchPrototype(prototype, fnNames) {
  ...
  for (let i28 = 0; i28 < fnNames.length; i28++) {
    const name = fnNames[i28];
...
function patchOnProperties(obj, properties, prototype) {
  if (properties) {
    for (let i28 = 0; i28 < properties.length; i28++) {
      patchProperty(obj, "on" + properties[i28], prototype);
    }
  } else {
    const onProperties = [];
...
function patchClass(className) {
  ...
  _global[className] = function() {
    const a42 = bindArguments(arguments, className);
    switch (a42.length) {
      case 0:
        this[originalInstanceKey] = new OriginalClass();
        break;
      case 1:
        this[originalInstanceKey] = new OriginalClass(a42[0]);
        break;
      case 2:
        this[originalInstanceKey] = new OriginalClass(a42[0], a42[1]);
        break;
      case 3:
        this[originalInstanceKey] = new OriginalClass(a42[0], a42[1], a42[2]);
        break;
      case 4:
        this[originalInstanceKey] = new OriginalClass(a42[0], a42[1], a42[2], a42[3]);
        break;
      default:
...
function patchEventTarget(_global2, api, apis, patchOptions) {
  ...
  function globalCallback(context, event, isCapture) {
    ...
    if (tasks) {
      ...
      if (tasks.length === 1) {
        ...
        for (let i28 = 0; i28 < copyTasks.length; i28++) {
          if (event && event[IMMEDIATE_PROPAGATION_SYMBOL] === true) {
            break;
          }
          const err = invokeTask(copyTasks[i28], target, event);
          err && errors.push(err);
        }
      }
      if (errors.length === 1) {
        ...
        for (let i28 = 0; i28 < errors.length; i28++) {
          const err = errors[i28];
  ...
  function patchEventTargetMethods(obj, patchOptions2) {
    ...
    const customCancelGlobal = function(task) {
      if (!task.isRemoved) {
        ...
        if (existingTasks) {
          for (let i28 = 0; i28 < existingTasks.length; i28++) {
            const existingTask = existingTasks[i28];
            if (existingTask === task) {
              existingTasks.splice(i28, 1);
              task.isRemoved = true;
    ...
    const makeAddListener = function(nativeListener, addSource, customScheduleFn, customCancelFn, returnTarget2 = false, prepend = false) {
      return function() {
        ...
        if (unpatchedEvents) {
          for (let i28 = 0; i28 < unpatchedEvents.length; i28++) {
            if (eventName === unpatchedEvents[i28]) {
              if (passive) {
        ...
        if (existingTasks) {
          ...
          if (checkDuplicate) {
            for (let i28 = 0; i28 < existingTasks.length; i28++) {
              if (compare(existingTasks[i28], delegate)) {
                return;
              }
            }
          }
    ...
    proto[LISTENERS_EVENT_LISTENER] = function() {
      ...
      for (let i28 = 0; i28 < tasks.length; i28++) {
        const task = tasks[i28];
    ...
    proto[REMOVE_ALL_LISTENERS_EVENT_LISTENER] = function() {
      ...
      if (!eventName) {
        ...
        for (let i28 = 0; i28 < keys.length; i28++) {
          const prop = keys[i28];
        ...
        if (symbolEventNames) {
          ...
          if (tasks) {
            ...
            for (let i28 = 0; i28 < removeTasks.length; i28++) {
              const task = removeTasks[i28];
              let delegate = task.originalDelegate ? task.originalDelegate : task.callback;
  ...
  let results = [];
  for (let i28 = 0; i28 < apis.length; i28++) {
    results[i28] = patchEventTargetMethods(apis[i28], patchOptions);
  }
  return results;
}
...
function eventTargetPatch(_global2, api) {
  ...
  for (let i28 = 0; i28 < eventNames.length; i28++) {
    const eventName = eventNames[i28];
...
function propertyDescriptorPatch(api, _global2) {
  ...
  for (let i28 = 0; i28 < patchTargets.length; i28++) {
    const target = _global2[patchTargets[i28]];
...
function patchBrowser(Zone3) {
  ...
  Zone3.__load_patch("blocking", (global2, Zone4) => {
    ...
    for (let i28 = 0; i28 < blockingMethods.length; i28++) {
      const name = blockingMethods[i28];
      patchMethod(global2, name, (delegate, symbol, name2) => {
        return function(s11, args) {
            ...
            if (!data.aborted && target[XHR_SCHEDULED] && task.state === SCHEDULED) {
              ...
              if (target.status !== 0 && loadTasks && loadTasks.length > 0) {
                ...
                task.invoke = function() {
                  ...
                  for (let i28 = 0; i28 < loadTasks2.length; i28++) {
                    if (loadTasks2[i28] === task) {
                      loadTasks2.splice(i28, 1);
                    }
                  }
...
function patchPromise(Zone3) {
  Zone3.__load_patch("ZoneAwarePromise", (global2, Zone4, api) => {
    ...
    api.onUnhandledError = (e58) => {
      if (api.showUncaughtError()) {
        const rejection = e58 && e58.rejection;
        if (rejection) {
          console.error("Unhandled Promise rejection:", rejection instanceof Error ? rejection.message : rejection, "; Zone:", e58.zone.name, "; Task:", e58.task && e58.task.source, "; Value:", rejection, rejection instanceof Error ? rejection.stack : void 0);
        } else {
          console.error(e58);
        }
      }
    ...
    function makeResolver(promise, state) {
      return (v3) => {
        try {
          resolvePromise(promise, state, v3);
        } catch (err) {
    ...
    function resolvePromise(promise, state, value) {
      ...
      if (promise[symbolState] === UNRESOLVED) {
        ...
        if (state !== REJECTED && value instanceof ZoneAwarePromise && value.hasOwnProperty(symbolState) && value.hasOwnProperty(symbolValue) && value[symbolState] !== UNRESOLVED) {
          ...
          for (let i28 = 0; i28 < queue.length; ) {
            scheduleResolveOrReject(promise, queue[i28++], queue[i28++], queue[i28++], queue[i28++]);
          }
    ...
    function clearRejectedNoCatch(promise) {
      if (promise[symbolState] === REJECTED_NO_CATCH) {
        ...
        for (let i28 = 0; i28 < _uncaughtPromiseErrors.length; i28++) {
          if (promise === _uncaughtPromiseErrors[i28].promise) {
            _uncaughtPromiseErrors.splice(i28, 1);
          }
        }
      }
    }
      ...
      static any(values) {
        ...
        try {
          for (let v3 of values) {
            count++;
            promises.push(ZoneAwarePromise.resolve(v3));
          }
        } catch (err) {
          return Promise.reject(new AggregateError([], "All promises were rejected"));
        }
        ...
        return new ZoneAwarePromise((resolve, reject) => {
          for (let i28 = 0; i28 < promises.length; i28++) {
            promises[i28].then((v3) => {
              if (finished) {
                return;
              }
              finished = true;
