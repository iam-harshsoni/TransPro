...
<div class="page-header">\r
    ...
    <div class="page-title">Trucks</div>\r
    <div class="page-subtitle">Manage your fleet of trucks</div>\r
</div>\r
\r
<div class="card">\r
\r
    <p-toolbar class="table-toolbar">\r
        <ng-template #start>\r
            <p-iconfield>\r
                ...
                <input pInputText type="text" placeholder="Search trucks..." (input)="onSearch($event)" />\r
            </p-iconfield>\r
        </ng-template>\r
        <ng-template #end>\r
            <p-button label="New Truck" icon="pi pi-plus" (onClick)="navigateToCreate()" />\r
\r
        </ng-template>\r
    </p-toolbar>\r
\r
    <p-table #dt [value]="trucks()" [loading]="isLoading()" [lazy]="true" (onLazyLoad)="onLazyLoad($event)"\r
        ...
        currentPageReportTemplate="Showing {first} to {last} of {totalRecords} trucks"\r
        [tableStyle]="{ 'min-width': '55rem' }">\r
\r
        <ng-template pTemplate="caption">\r
            <div class="table-caption">\r
                <span class="table-title">Fleet List</span>\r
...
\r
        <ng-template pTemplate="header">\r
            <tr>\r
                <th pSortableColumn="plateNumber" style="min-width: 12rem">\r
                    Plate Number <p-sortIcon field="plateNumber" />\r
                </th>\r
                <th pSortableColumn="model" style="min-width: 14rem">\r
                    Model <p-sortIcon field="model" />\r
                </th>\r
                <th pSortableColumn="capacity" style="min-width: 10rem">\r
                    Capacity <p-sortIcon field="capacity" />\r
                </th>\r
                <th style="min-width: 10rem">Availability</th>\r
            </tr>\r
        </ng-template>\r
\r
        <ng-template pTemplate="body" let-truck>\r
            <tr>\r
                <td>\r
                    <span class="plate-number breadcrumb-link cursor-pointer" pTooltip="Edit" tooltipPosition="top"\r
                        (click)="navigateToEdit(truck)">{{\r
                        truck.plateNumber }}</span>\r
                </td>\r
                <td>\r
                    <div class="truck-model-cell">\r
                        <span class="row-name"> {{ truck.model }}</span>\r
                    </div>\r
                </td>\r
                <td>\r
                    <p-tag [value]="getCapacityLabel(truck.capacity)"\r
                        [severity]="getCapacitySeverity(truck.capacity)" />\r
                </td>\r
                <td>\r
                    <p-tag [value]="truck.isAvailable ? 'Available' : 'Unavailable'"\r
                        [severity]="getSeverity(truck.isAvailable)" />\r
                </td>\r
            </tr>\r
        </ng-template>\r
\r
            ...
            <tr>\r
                <td colspan="5">\r
                    <div class="empty-state">\r
                        ...
                        <span>No trucks found</span>\r
                        <small>Add your first truck to get started</small>\r
                    </div>\r
                </td>\r
            </tr>\r
        </ng-template>\r
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(TruckListComponent, { className: "TruckListComponent", filePath: "app/features/trucks/pages/truck-list/truck-list.component.ts", lineNumber: 40 });
})();
export {
  TruckListComponent
};
//# sourceMappingURL=chunk-UXX3COQL.js.map
