...
\r
        <div class="login-header">\r
            ...
            <p class="login-subtitle">Sign in to your admin dashboard</p>\r
        </div>\r
\r
...
\r
            ...
            <div class="form-field">\r
                ...
                <input pInputText formControlName="email" type="email" placeholder="admin@transpro.com"\r
                    autocomplete="email" [class.input-error]="isInvalid('email')" />\r
...
\r
            ...
            <div class="form-field">\r
                ...
                <!--\r
                    p-password is PrimeNG's password input.\r
                    [feedback]="false" hides the strength meter \u2014 not needed on login.\r
                    [toggleMask]="true" adds the show/hide eye icon.\r
                    -->\r
                <p-password formControlName="password" placeholder="Enter your password" [feedback]="false"\r
                    [toggleMask]="true" styleClass="w-full" autocomplete="current-password"\r
                    [class.input-error]="isInvalid('password')" />\r
                @if (isInvalid('password')) {\r
                <small class="error-msg">\r
                    @if (form.get('password')?.hasError('required')) { Password is required. }\r
                    @if (form.get('password')?.hasError('minlength')) { Min 6 characters. }\r
                </small>\r
                }\r
            </div>\r
\r
            <!-- Submit -->\r
            <p-button label="Sign In" icon="pi pi-sign-in" type="submit" styleClass="login-btn"\r
                [loading]="isLoading()" />\r
\r
        </form>\r
\r
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LoginComponent, { className: "LoginComponent", filePath: "app/features/auth/login/login.component.ts", lineNumber: 28 });
})();
export {
  LoginComponent
};
//# sourceMappingURL=chunk-2L6YYBTA.js.map
