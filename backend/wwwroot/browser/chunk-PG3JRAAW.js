...
<div class="page-header">\r
    <div class="breadcrumb-trail">\r
        ...
        <span>Containers</span>\r
    </div>\r
    <div class="page-title">Containers</div>\r
    <div class="page-subtitle">Manage your containers records</div>\r
</div>\r
\r
<div class="card">\r
    <p-toolbar class="table-toolbar">\r
        <ng-template #start>\r
            <p-iconfield>\r
                ...
                <input pInputText type="text" placeholder="Search containers..." (input)="onSearch($event)" />\r
            </p-iconfield>\r
        </ng-template>\r
        <ng-template #end>\r
...
\r
    <p-table #dt [value]="containers()" [loading]="isLoading" [lazy]="true" (onLazyLoad)="onLazyLoad($event)"\r
        ...
        currentPageReportTemplate="Showing {first} to {last} of {totalRecords} containers"\r
        [tableStyle]="{ 'min-width': '55rem' }">\r
\r
        <ng-template pTemplate="caption">\r
            <div class="table-caption">\r
                <span class="table-title">Container List:</span>\r
...
\r
        <ng-template pTemplate="header">\r
            <tr>\r
                <th pSortableColumn="containerNumber" style="min-width: 14rem">\r
                    Container No. <p-sortIcon field="containerNumber" />\r
                </th>\r
                <th pSortableColumn="type" style="min-width: 16rem">\r
                    Type <p-sortIcon field="Type" />\r
                </th>\r
                <th pSortableColumn="weightCapacity" style="min-width: 11rem">\r
                    Weight Capacity <p-sortIcon field="weightCapacity" />\r
                </th>\r
                <th pSortableColumn="isAvailable" style="min-width: 10rem">\r
                    Availability <p-sortIcon field="isAvailable" />\r
                </th>\r
                <th pSortableColumn="createdAt" style="min-width: 11rem">\r
                    Created <p-sortIcon field="createdAt" />\r
                </th>\r
            </tr>\r
        </ng-template>\r
\r
        <ng-template pTemplate="body" let-container>\r
            <tr>\r
                <td><span class="breadcrumb-link cursor-pointer" pTooltip="Edit" tooltipPosition="top"\r
                        (click)="navigateToEdit(container)">{{ container.containerNumber }}</span></td>\r
                <td>\r
                    <p-tag [value]="container.type" [severity]="getTypeSeverity(container.type)" />\r
                </td>\r
                <td>{{ container.weightCapacity }}</td>\r
                <td>{{ container.createdAt }}</td>\r
                <td>\r
                    <p-tag [value]="container.isAvailable ? 'Available' : 'Occupied'"\r
                        [severity]="getSeverity(container.isAvailable)" />\r
                </td>\r
            </tr>\r
        </ng-template>\r
\r
            ...
            <tr>\r
                <td colspan="6">\r
                    <div class="empty-state">\r
                        ...
                        <span>No container found</span>\r
                        <small>Add your first container to get started</small>\r
                    </div>\r
                </td>\r
            </tr>\r
        </ng-template>\r
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ContainerListComponent, { className: "ContainerListComponent", filePath: "app/features/containers/pages/container-list/container-list.component.ts", lineNumber: 40 });
})();
export {
  ContainerListComponent
};
//# sourceMappingURL=chunk-PG3JRAAW.js.map
