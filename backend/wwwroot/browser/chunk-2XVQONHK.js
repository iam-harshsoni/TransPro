...
<div class="page-header">\r
    <div class="breadcrumb-trail">\r
        ...
        Containers <i class="pi pi-angle-right"></i>\r
        <span>{{ isEditMode() ? 'Edit Container' : 'New Container' }}</span>\r
    </div>\r
    <div class="page-title">{{ isEditMode() ? 'Edit Container' : 'New Container' }}</div>\r
</div>\r
\r
<div class="form-card">\r
    <div class="card-header">\r
        <span class="card-title">Container Information</span>\r
    </div>\r
\r
    <div class="card-body">\r
        <form [formGroup]="form" (ngSubmit)="onSubmit()">\r
\r
            <div class="form-section-title">Container Details</div>\r
\r
...
\r
                ...
                <div class="form-field">\r
                    <label class="form-label">\r
                        Container Number <span class="required-star">*</span>\r
                    </label>\r
\r
                    <input pInputText formControlName="containerNumber" placeholder="e.g. CMAU2906501"\r
                        [class.input-error]="isInvalid('containerNumber')" />\r
                    @if (isInvalid('containerNumber')) {\r
                    <small class="error-msg">\r
                        @if (form.get('containerNumber')?.hasError('required')) {\r
                        Container number is required.\r
                        }\r
                        @if (form.get('containerNumber')?.hasError('maxlength')) {\r
                        Max 50 characters.\r
                        }\r
                    </small>\r
                    }\r
...
\r
                ...
                <div class="form-field">\r
                    <label class="form-label">\r
                        Container Type <span class="required-star">*</span>\r
                    </label>\r
                    <!--\r
                        p-select is PrimeNG's dropdown component.\r
                        [options] = the array of options to show\r
                        optionLabel = which property to display as the label\r
                        optionValue = which property to use as the form value\r
                        placeholder = shown when nothing is selected\r
                    -->\r
                    <p-select formControlName="type" [options]="containerTypes" optionLabel="label" optionValue="value"\r
                        placeholder="Select container type" [class.input-error]="isInvalid('type')" />\r
                    @if (isInvalid('type')) {\r
                    <small class="error-msg">Container type is required.</small>\r
                    }\r
                </div>\r
\r
                <!-- Weight Capacity -->\r
                <div class="form-field">\r
                    <label class="form-label">\r
                        Weight Capacity (tons) <span class="required-star">*</span>\r
                    </label>\r
                    <!--\r
                        p-inputnumber with [minFractionDigits] and [maxFractionDigits]\r
                        allows decimal values like 25.9 tons.\r
                        [min]="0.1" prevents entering zero or negative values.\r
                    -->\r
                    <p-inputnumber formControlName="weightCapacity" [min]="0.1" [minFractionDigits]="1"\r
                        [maxFractionDigits]="2" placeholder="e.g. 25.5" styleClass="w-full"\r
                        [class.input-error]="isInvalid('weightCapacity')" />\r
                    @if (isInvalid('weightCapacity')) {\r
                    <small class="error-msg">\r
                        @if (form.get('weightCapacity')?.hasError('required')) {\r
                        Weight capacity is required.\r
                        }\r
                        @if (form.get('weightCapacity')?.hasError('min')) {\r
...
\r
                <!-- Availability Toggle -->\r
                <div class="form-field">\r
                    <label class="form-label">Availability</label>\r
                    <div class="toggle-row">\r
                        <p-toggleswitch formControlName="isAvailable" />\r
                        <span class="toggle-label">\r
                            {{ form.get('isAvailable')?.value ? 'Available' : 'Occupied' }}\r
                        </span>\r
                    </div>\r
                    <small class="form-hint">\r
                        Mark as Available if this container is ready to be assigned to a trip.\r
                    </small>\r
                </div>\r
\r
            </div>\r
\r
            <div class="form-actions">\r
                ...
                <p-button [label]="isEditMode() ? 'Update Container' : 'Create Container'" icon="pi pi-check"\r
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ContainerFormComponent, { className: "ContainerFormComponent", filePath: "app/features/containers/pages/container-form/container-form.component.ts", lineNumber: 31 });
})();
export {
  ContainerFormComponent
};
//# sourceMappingURL=chunk-2XVQONHK.js.map
