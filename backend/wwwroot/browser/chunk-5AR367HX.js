...
<div class="page-header">\r
    <div class="breadcrumb-trail">\r
        ...
        <a class="breadcrumb-link" (click)="onCancel()">Driver</a>\r
        <i class="pi pi-angle-right"></i>\r
        <span>{{ isEditMode() ? 'Edit Driver' : 'New Driver' }}</span>\r
    </div>\r
    <!-- Ternary operator in template: condition ? valueIfTrue : valueIfFalse -->\r
    <div class="page-title">{{ isEditMode() ? 'Edit Driver' : 'New Driver' }}</div>\r
</div>\r
\r
<div class="form-card">\r
    <div class="card-header">\r
        <span class="card-title">Driver Information</span>\r
    </div>\r
\r
...
\r
                ...
                <div class="form-field">\r
                    <label class="form-label">\r
                        Driver Name <span class="required-star">*</span>\r
                    </label>\r
\r
                    <input pInputText formControlName="fullName" placeholder="Enter driver full name"\r
...
\r
                <!-- License Number Field -->\r
                <div class="form-field">\r
                    <label class="form-label">\r
                        License Number <span class="required-star">*</span>\r
                    </label>\r
\r
                    <input pInputText formControlName="licenseNumber" placeholder="Enter driver full name"\r
                        [class.input-error]="isInvalid('licenseNumber')" />\r
\r
                    @if (isInvalid('licenseNumber')) {\r
                    <small class="error-msg">\r
                        @if (form.get('licenseNumber')?.hasError('required')) { License Number is required. }\r
                        @if (form.get('licenseNumber')?.hasError('maxlength')) { Max 100 characters. }\r
                    </small>\r
                    }\r
                </div>\r
\r
...
\r
                <div class="availability-form-section">\r
                    <div class="availability-toggle-row">\r
                        <div class="availability-info">\r
                            <span class="availability-title">Driver Availability</span>\r
                            <span class="availability-desc">\r
                                Toggle whether this driver is available for new trip assignments.\r
                                Cannot be marked available if driver has an active trip in transit.\r
                            </span>\r
                        </div>\r
\r
                        <div class="availability-control">\r
                            <p-toggleswitch formControlName="isAvailable" />\r
                            <span class="availability-status-label"\r
                                [class.status-available]="form.get('isAvailable')?.value"\r
                                [class.status-unavailable]="!form.get('isAvailable')?.value">\r
                                {{ form.get('isAvailable')?.value ? 'Available' : 'Unavailable' }}\r
                            </span>\r
                        </div>\r
                    </div>\r
                </div>\r
...
\r
            ...
            <div class="form-actions">\r
                ...
                <p-button [label]="isEditMode() ? 'Update Driver' : 'Create Driver'" icon="pi pi-check" type="submit"\r
                    [loading]="isSaving()" />\r
            </div>\r
        </form>\r
    </div>\r
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DriverFormComponent, { className: "DriverFormComponent", filePath: "app/features/drivers/pages/driver-form/driver-form.component.ts", lineNumber: 29 });
})();
export {
  DriverFormComponent
};
//# sourceMappingURL=chunk-5AR367HX.js.map
